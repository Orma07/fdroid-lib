...
import amro.com.fdroidsdk.net.ConnectivityMonitorService;
 ...
 * accessed via the {@link amro.com.fdroidsdk.Preferences#get()}
 * singleton method.
 * <p>
...
public final class Preferences implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public String getLanguage() {
        return preferences.getString(Preferences.PREF_LANGUAGE, Locale.getDefault().getCountry());
    }
