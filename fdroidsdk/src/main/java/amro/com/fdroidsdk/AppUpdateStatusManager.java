...
import amro.com.fdroidsdk.data.Apk;
import amro.com.fdroidsdk.data.App;
import amro.com.fdroidsdk.data.AppProvider;
import amro.com.fdroidsdk.data.Repo;
import amro.com.fdroidsdk.installer.ErrorDialogActivity;
import amro.com.fdroidsdk.installer.InstallManagerService;
...
public final class AppUpdateStatusManager {
     ...
     */
    public static final String BROADCAST_APPSTATUS_LIST_CHANGED = "amro.com.fdroidsdk.installer.appstatus.listchange";

    /**
     * Broadcast when an app begins the download/install process (either manually or via an automatic download).
     */
    public static final String BROADCAST_APPSTATUS_ADDED = "amro.com.fdroidsdk.installer.appstatus.appchange.add";

    /**
     * When the {@link AppUpdateStatus#status} of an app changes or the download progress for an app advances.
     */
    public static final String BROADCAST_APPSTATUS_CHANGED = "amro.com.fdroidsdk.installer.appstatus.appchange.change";
     ...
     */
    public static final String BROADCAST_APPSTATUS_REMOVED = "amro.com.fdroidsdk.installer.appstatus.appchange.remove";
